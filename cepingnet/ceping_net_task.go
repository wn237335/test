...
func Nettask()  {
	...
	for _, i2 := range ceping_net_task1 {
		var ce CPTaskMeta
		ce.TaskTemplateUID = "CP_TEMPLATE_WEB"
		ce.CallbackUrl = i2.CallbackUrl
		ce.CommonName = i2.Name
		ce.WebURL = i2.Address
		ce.CallbackUrl = i2.CallbackUrl
	...
	//	Ipataskresult1(i2.Id, result, i2.RequestId)
		Nettaskresult(i2.Id, result, i2.RequestId, int(uint(r.Int63())))
		break
	}
