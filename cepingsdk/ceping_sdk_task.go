...
type ceping_sdk_task struct {
	...
	SdkFilename string `json:"sdk_filename"`
...
func Sdktask()  {
	...
	for _, i2 := range ceping_sdk_task1 {
		var ce CPTaskMeta
	//	ce.TaskTemplateUID = "CP_TEMPLATE_WEB"
		...
		ce.Type = "Sdk"
		ce.SDKType = i2.SdkTag
		ce.CommonName = i2.SdkName
		ce.FileName = i2.SdkFilename
		ce.FileMd5 = i2.SdkMd5
		ce.Md5 = i2.SdkMd5
		ce.ProductKey = "SDKAudit"
		...
		Sdktaskresult(i2.Id, result, i2.RequestId, int(uint(r.Int63())))
		break
	}
}